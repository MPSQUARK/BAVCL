...
public partial class TestCls
{
    ...
    public unsafe static double LOG2_v2(double N)
    {
        ...
        {
            // range 1.75 <= x < 2.0
            0b0_00000000000_1100000000000000000000000000000000000000000000000000 => (d * (d * (d * ((0.0124508f * d - 0.145908f) * d + 0.72954f) - 2.05183f) + 3.84718f) - 2.38726f) + E,
            // range 1.50 <= x < 1.75
            0b0_00000000000_1000000000000000000000000000000000000000000000000000 => (d * (d * (d * ((0.0254646f * d - 0.258625f) * d + 1.12071f) - 2.73173f) + 4.43906f) - 2.59371f) + E,
            // range 1.25 <= x < 1.50
            0b0_00000000000_0100000000000000000000000000000000000000000000000000 => (d * (d * (d * ((0.0587072f * d - 0.504515f) * d + 1.84989f) - 3.81539f) + 5.24616f) - 2.83472f) + E,
            // range 1.00 <= x < 1.25
            0b0_00000000000_0000000000000000000000000000000000000000000000000000 => (d * (d * (d * ((0.160119f * d - 1.12584f) * d + 3.37751f) - 5.69954f) + 6.41199f) - 3.12423f) + E,
            _ => 0,
        };
    }
