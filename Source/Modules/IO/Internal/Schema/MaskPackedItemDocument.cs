...
/// <summary>Per-item packed-mask JSON payload inside a collection file.</summary>
internal sealed class MaskPackedItemDocument
{
	...
	[JsonPropertyName(IoSchema.Field.Count)]
